...
%% Channel gains
        channel_BS1_RS1=(sqrt(10)/sqrt(2)).*[randn(1,N/3)+1i*randn(1,N/3)];% Channel coefficients for Source-Relay1 Link
        ...
        channel_BS1_RS2=(sqrt(10)/sqrt(2))*[randn(1,N/3)+1i*randn(1,N/3)];% Channel coefficients for Source-Relay2 Link
...
for       i=1:length(p_db)
               ...
               % No(i)=Pt./snr_linear(i);            % Noise power
                Pb = sqrt((10* p_linear(i)+1)*( p_linear(i)+1))/9-( p_linear(i)*10 +1)/9;
                Pr1 =  (p_linear(i)-Pb)/2;%optimal power allocation
                Pr2 = Pr1;
...
save('Af_L=8_2p_optimal.mat','error_af1');
